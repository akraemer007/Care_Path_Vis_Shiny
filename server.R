...
CarePathData.Tidy <- CarePathData %>%
  ...
  mutate( PrePostFlag <- factor( PrePostFlag, levels = c( 'Pre', 'Post' ) ),
          ...
          organization_parent_name = ifelse( organization_parent_name == 'Avera McKennan Hospi', 'Client 1',
                                             ifelse( organization_parent_name == 'Meriter Health Servi', 'Client 2',
                                                     ifelse( organization_parent_name == 'UW Health (PARENT OR', 'Client 3',
                                                             ifelse( organization_parent_name == 'Virtua Health System', 'Client 4',
